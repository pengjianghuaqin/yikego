package com.yikego.android.rom.sdk.rest;
...
//      httpParams.setParameter(ClientPNames.COOKIE_POLICY, CookiePolicy.BROWSER_COMPATIBILITY);
	...
	protected static <T> T get(String uri, Class<T> resultClass) throws IOException, HttpException {
		Log.v("get", "resultClass ="+resultClass);
	...
	protected static String post(String uri, Object resultClass) throws IOException, HttpException {
		Log.v("post", "uri ="+uri);
		HttpPost httpPost = new HttpPost(uri);
		httpPost.setHeader("Accept", "application/json");
		httpPost.setHeader("Content-Type", "application/json");
		httpPost.setEntity(new StringEntity (GSON.toJson(resultClass), "UTF-8"));
		ResponseHandler<String> handler = new ResponseHandler<String>() {
